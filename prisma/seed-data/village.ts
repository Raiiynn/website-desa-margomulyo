...
export const SITE_SETTINGS = [
  ...
  {
    key: 'village.territoryIntro',
    value:
      'Kalurahan Margomulyo merupakan salah satu kalurahan di Kapanewon Seyegan, Kabupaten Sleman, Daerah Istimewa Yogyakarta. Margomulyo memiliki karakter wilayah perdesaan yang subur dan berada persis di pusat denyut pemerintahan Kapanewon Seyegan.',
    group: 'identity',
    label: 'Pengantar wilayah',
    type: 'TEXT',
  },
  {
    key: 'village.areaCaption',
    value: 'Didominasi area persawahan teknis beririgasi mandiri dan pemukiman hijau asri.',
    group: 'identity',
    label: 'Keterangan luas wilayah',
    type: 'TEXT',
  },
  {
    key: 'village.padukuhanCaption',
    value: 'Menampung keanekaragaman paguyuban warga dari Mriyan hingga Gerjen.',
    group: 'identity',
    label: 'Keterangan padukuhan',
    type: 'TEXT',
  },
  {
    key: 'village.rwCaption',
    value: 'Koordinasi terpadu pemeliharaan ketertiban, keamanan, dan kebersihan lingkungan.',
    group: 'identity',
    label: 'Keterangan rukun warga',
    type: 'TEXT',
  },
